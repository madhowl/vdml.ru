...
use App\Orchid\Screens\ProductsChart;
...
use \App\Orchid\Screens\StatusListScreen;
use \App\Orchid\Screens\OrderListScreen;
use \App\Orchid\Screens\StatusEditScreen;
...
// Main
Route::screen('/main', ProductsChart::class)
    ->name('platform.main');

Route::screen('/main1', PlatformScreen::class)
    ->name('platform.main1');
...
Route::screen('statuses', StatusListScreen::class)
